...
trait AddItemTrait
{
    ...
    public function addItemAction(Request $request, AddItemService $service, SerializationContextFetcher $serializationContextFetcher): Response
    {
        ...
        $result = $service->add($request->getContent(), $entityClass, [ValidationService::GROUP_DEFAULT, ValidationService::GROUP_CREATE], $serializationContext, $serializationContext, $request->get('fields'));
