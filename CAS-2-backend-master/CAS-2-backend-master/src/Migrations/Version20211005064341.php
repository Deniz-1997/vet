 ...
 */
final class Version20211005064341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql("DELETE FROM action.action WHERE id=(select id from action.action where code='businessEntity')");
        $this->addSql("DELETE FROM action.action WHERE id=(select id from action.action where code='supervisedObjects')");
    }
