...
class Action
{
     ...
     * @ORM\ManyToOne(targetEntity="App\Entity\Reference\Action", inversedBy="items")
     */
    private $parent;
     ...
     * @Groups({"default"})
     * @SerializeNestedIgnore()
     * @ORM\OneToMany(targetEntity="App\Entity\Reference\Action", mappedBy="parent")
     */
    private $items;
     ...
     * @Groups({"default"})
     * @ORM\Column(type=ActionTypeEnum::class)
     */
    private $type;
