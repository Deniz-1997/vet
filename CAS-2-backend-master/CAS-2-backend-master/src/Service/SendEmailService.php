...
class SendEmailService
{
    ...
    public function __construct(EntityManagerInterface $om, EmailThemeRepositories $repositories, Twig_Environment $twig, Swift_Mailer $mailer, ResourcePathService $resourcePath) {
        $this->om = $om;
        $this->twig = $twig;
        $this->mailer = $mailer;
