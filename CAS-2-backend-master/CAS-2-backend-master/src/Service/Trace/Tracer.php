...
class Tracer
{
    ...
    {
        $this->serviceName = $serviceName ? $serviceName : getenv('MICROSERVICE_NAME');
    }
    ...
    public static function getInstance($serviceName = null): Tracer
    {
        ...
        $reporter = new Http(new AsyncCurlFactory(), ['endpoint_url' => getenv('ZIPKIN_ENDPOINT_URL')]);
    ...
    {
        return isset($this->spans[$id]) ? $this->spans[$id] : null;
    }
