...
export class Vet2NonContagiousAnimalsDiseasesSettingsModel extends ReportModel {

  public readonly showTotalRow = false;
  public readonly showFooter: boolean = false;
  public readonly fxFlex = '33.333%';
  public readonly title = 'Сведения о заболеваемости молодняка незаразными болезнями (гол.)';
