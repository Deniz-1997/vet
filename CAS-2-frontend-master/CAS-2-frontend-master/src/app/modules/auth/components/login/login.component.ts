...
import {GetTokenAction} from '../../../../api/auth/auth.actions';
import {AuthState} from '../../../../api/auth/auth.reducer';
import {AuthTokenService} from '../../../../api/auth/auth-token.service';
import {TokenAuthModel} from '../../../../api/auth/auth.models';
import {getToken, getTokenLoading} from '../../../../api/auth/auth.selectors';

@Component({templateUrl: './login.component.html', styleUrls: ['../auth.scss']})
