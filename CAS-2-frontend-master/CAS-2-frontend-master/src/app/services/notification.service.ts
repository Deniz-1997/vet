...
export class NotificationService {
  ...
  private async webSocketConnect(): Promise<void> {
  ...
  public getNotificationsList(from: number = 0, to: number = 5, callback: (anyData: any, nitificationNumber: number) => void): void {
  ...
  public setNotificationViewed(notification: MainNotificationModel, callback: (anyData: any) => void): void {
