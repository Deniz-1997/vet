...
@Component({templateUrl: './add-leaving.component.html'})

export class AddLeavingComponent implements OnInit {
  ...
  ngOnInit() {
    const leavingId = this.route.snapshot.paramMap.get('leavingId');
