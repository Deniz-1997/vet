...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'notifications-channel'];
  protected titleName = 'Вид деятельности владельца';
  ...
  constructor(
    ...
    super(CrudType.ReferenceNotificationsChannel, ReferenceNotificationsChannelModel);
  }
