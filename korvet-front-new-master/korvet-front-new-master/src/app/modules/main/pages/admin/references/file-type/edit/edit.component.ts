...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'file-type'];
  protected titleName = 'Вид файла';
  ...
  constructor(
    ...
    super(CrudType.ReferenceFileType, ReferenceFileTypeModel, data.id, data.openDialog);
  }
