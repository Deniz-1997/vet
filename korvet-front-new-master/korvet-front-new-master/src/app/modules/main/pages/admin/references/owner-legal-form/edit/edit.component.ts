...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'owner-legal-form'];
  protected titleName = 'Правовая форма';
  ...
  constructor(
    ...
    super(CrudType.ReferenceOwnerLegalForm, ReferenceOwnerLegalFormModel, data.id, data.openDialog);
  }
