...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'sterilization-type'];
  protected titleName = 'Вид стерилизации';
  ...
  constructor(
    ...
    super(CrudType.ReferenceSterilizationType, ReferenceEventTypeModel, data.id, data.openDialog);
  }
