...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'profession'];
  protected titleName = 'Специальность';
  ...
  constructor(
    ...
    super(CrudType.ReferenceProfession, ReferenceProfessionModel, data.id, data.openDialog);
  }
