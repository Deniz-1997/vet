...
import {ReferenceTagFormModel} from '../../../../../../../models/reference/reference.tag.form.models';
...
export class EditComponent extends ReferenceItemModels {
  protected listNavigate = ['admin', 'references', 'tag-form'];
  protected titleName = 'Форму бирки';
  ...
  constructor(
    ...
    super(CrudType.ReferenceTagForm, ReferenceTagFormModel, data.id, data.openDialog);
  }
