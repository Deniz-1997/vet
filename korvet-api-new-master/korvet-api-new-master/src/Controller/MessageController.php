...
class MessageController extends AbstractController
{
     ...
     * @return Response
     */
    public function getMessage(Request $request, DependenciesService $dependenciesService): Response
    {
        ...
        $this->rabbitRestClient = new RabbitRestClient(Env::getenv('RABBITMQ_HOST'), $host, Env::getenv('RABBITMQ_HTTP_PROTOCOL'), Env::getenv('RABBITMQ_HTTP_PORT'), Env::getenv('RABBITMQ_USERNAME'), Env::getenv('RABBITMQ_PASSWORD'));
     ...
     * @return BaseResponse
     */
    private function handleResponse(array $result): BaseResponse
    {
