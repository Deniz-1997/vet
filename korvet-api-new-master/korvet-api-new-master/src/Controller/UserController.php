...
class UserController extends ApiController
{
     ...
     * @Route("/", methods={"POST"})
     */
    public function registerAction(Request $request, UserPasswordHasherInterface $passwordEncoder, UserRepository $userRepository, BaseResponse $response, SerializerInterface $serializer, ValidationService $validator): Response
    {
        ...
        $user->setPassword(
            $passwordEncoder->hashPassword($user, $user->getPlainPassword())
        );
