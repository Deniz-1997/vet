 ...
 *     tags={"Leaving"},
 *     summariesMap={
 *          "list": "Получить список выездов",
 *          "get": "Получить выезд",
 *          "post": "Создать выезд",
 *          "delete": "Удалить выезд",
 *          "patch": "Обновить выезд"
 *     },
 *     descriptionsMap={
 *          "list": "Возвращает список выезд",
 *          "get": "Возвращает выезд по идентификатору",
 *          "post": "Создает новый выезд",
 *          "delete": "Удаляет существующий выезд",
 *          "patch": "Обновляет существующий выезд"
 *     }
 * )
 */
class LeavingController extends ApiController
{
    ...
    /**
     * @SWG\Post(
     *     summary="Создает новый кассовый чек для выезд",
     *     description="Создает новый кассовый чек для выезд",
     *     @SWG\Response(
     *         response=200,
     *         @SWG\JsonContent(),
