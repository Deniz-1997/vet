...
abstract class AbstractObjectNormalizer extends AbstractNormalizer
{
    ...
    public function normalize($object, $format = null, array $context = [])
    {
        ...
        foreach ($attributes as $attribute) {
            if (null !== $attributesMetadata && $this->isMaxDepthReached(
                $attributesMetadata,
                $class,
                $attribute,
                $context
        ...
        foreach ($stack as $attribute => $attributeValue) {
            ...
            $data = $this->updateData(
                ...
                $this->serializer->normalize(
                    $attributeValue,
                    $format,
                    $this->createChildContext($context, $attribute, null)
                )
            );
        }
    ...
    protected function getAttributes($object, $format = null, array $context): array
    {
        ...
        return $this->attributesCache[$class] = $this->extractAttributes(
            $object,
            $format,
            $context
        );
    ...
    {
        return $this->cache[$type] ?? $this->cache[$type] = class_exists($type);
    }
    ...
    public function denormalize($data, $type, $format = null, array $context = []): object
    {
        ...
        foreach ($normalizedData as $attribute => $value) {
            try {
                ...
                if ((false !== $allowedAttributes && !in_array(
                    $attribute,
                    $allowedAttributes,
                    true
    ...
    protected function generateEvent($normalizedData, $entity, $denormalizeErrors)
    {
        ...
        $this->eventDispatcher->dispatch($event, self::EVENT_NAME_SERIALIZER_EXCEPTION,);
    ...
    private function validateAndDenormalize(
        ...
        try {
            ...
            foreach ($types as $type) {
                ...
                $isEntity = (strpos($currentClass, 'App\Entity\\') !== false ||
                ...
                if (Type::BUILTIN_TYPE_OBJECT === $builtinType) {
                    ...
                    $childContext = $this->createChildContext($context, $attribute, null);
     ...
     * @param string $class
     * @param string $attribute
     * @return SerializeNestedIgnore|null
     * @throws ReflectionException
     */
    ...
    {
        if (
            !isset($context[static::ENABLE_MAX_DEPTH]) || !isset($attributesMetadata[$attribute]) ||
