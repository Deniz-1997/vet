...
class AddItemService extends AbstractService implements AddItemInterface
{
     ...
     * @throws \Exception
     */
    public function add(string $data, string $objectName, $validationGroup = null, array $inputSerializationContext = [], array $outputSerializationContext = []): ApiResponse
    {
        // for log
        $this->dependencies->originalData = array(
