...
abstract class AbstractService implements ApiServiceInterface
{
    ...
    public function mergeEntity(object $entity): BaseResponse
    {
        ...
        $entity = $this->mergeEntity($entity);
     ...
     */
    public function generateEvent($data, array $eventsList = [], array $attrs = []): EventRequest
    {
        ...
        foreach ($eventsList as $eventName) {
            ...
            $this->dependencies->getDispatcher()->dispatch($event, $eventName);
        }
