...
class DeserializeService
{
     ...
     */
    public function __construct(EntityManagerInterface $om, TranslatorInterface $translator, EventDispatcherInterface $eventDispatcher, PsrCachedReader $annotationReader, array $encoders = [], array $normalizers = [])
    {
        $defaultContext = [
        ...
        $defaultNormalizer = new DefaultNormalizer(null, null, null,
            new ReflectionExtractor(), $om, $translator, $eventDispatcher, $annotationReader, $defaultContext);
