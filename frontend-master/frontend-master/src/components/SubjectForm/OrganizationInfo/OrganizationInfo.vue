<template>
  <div class="general">
    <v-row>
      <v-col v-if="form.headSubject" cols="12" md="12">
        <InputComponent v-model="form.headSubject.name" label="Головная организация" disabled />
      </v-col>
      ...
      <v-col cols="3">
        <InputComponent v-model="form.created" label="Дата подачи заявления на регистрацию" disabled />
      </v-col>
      <v-col cols="3">
