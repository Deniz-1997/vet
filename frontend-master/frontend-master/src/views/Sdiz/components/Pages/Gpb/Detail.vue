<template>
  <sdiz-detail
    ...
    v-model="model"
    document-type-name="СДИЗ продуктов переработки"
  >
...
@Component({
  name: 'sdiz-gpb-detail',
  components: { ManufacturerAutocomplete, SdizDetail, UiDateInput, SelectRequestComponent },
})
export default class SdizGpbDetail extends Sdiz {
