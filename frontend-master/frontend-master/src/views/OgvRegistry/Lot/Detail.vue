<template>
  <lot-detail v-model="model" :is-show="false" :sdiz-model="sdizModel">
...
export default class LotOgvDetail extends Lot {
  model: LotDataOgvVueModel = new LotDataOgvVueModel();
  sdizModel: SdizOgvVueModel = new SdizOgvVueModel();
}
</script>
