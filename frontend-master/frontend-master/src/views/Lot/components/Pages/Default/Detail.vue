<template>
  <lot-detail v-if="accessGrantedAuthorities(model.view_data_privileges)" v-model="model" :sdiz-model="sdizModel">
...
export default class LotDefaultDetail extends Lot {
