export enum CADESCOM_STORE_LOCATION {
...
export enum CADESCOM_CADES_TYPE {
...
export enum CADESCOM_CONTENT_ENCODING_TYPE {
...
export enum CADESCOM_ATTRIBUTE {
...
export enum CADESCOM_DISPLAY_DATA {
...
export enum CAPICOM_STORE_LOCATION {
...
export enum CAPICOM_STORE_NAME {
  CAPICOM_MY_STORE = 'My',
  CAPICOM_CA_STORE = 'Ca',
...
export enum CAPICOM_OID {
  ...
  CAPICOM_OID_BASIC_exportRAINTS_EXTENSION = 8,
  ...
  CAPICOM_OID_BASIC_exportRAINTS2_EXTENSION = 14,
  CAPICOM_OID_NAME_exportRAINTS_EXTENSION = 15,
  ...
  CAPICOM_OID_POLICY_exportRAINTS_EXTENSION = 20,
  ...
  CAPICOM_OID_APPLICATION_POLICY_exportRAINTS_EXTENSION = 25,
