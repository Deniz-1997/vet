declare namespace CAdESCOM {
  import { CADESCOM_ATTRIBUTE, CADESCOM_CADES_TYPE, CADESCOM_CONTENT_ENCODING_TYPE, CADESCOM_DISPLAY_DATA, CADESCOM_XML_SIGNATURE_TYPE, CAPICOM_CERTIFICATE_INCLUDE_OPTION, CAPICOM_ENCODING_TYPE, CAPICOM_HASH_ALGORITHM } from "@/services/enums/signature";
