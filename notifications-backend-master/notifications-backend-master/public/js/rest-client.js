            ...
            /***/ (function (module, exports, __webpack_require__) {
                ...
                var RestClient = function () {
                    ...
                    _createClass(RestClient, [{
                        ...
                        value: function _request(method, url) {
                            ...
                            if (method !== "GET") link += "?api_token=" + this._opts.apiToken;
                            ...
                            xhr.responseType = this._opts.responseType;
                                ...
                                return xhr.onreadystatechange = function () {
                                    if (xhr.readyState === 4) {
                                        ...
                                        if (responseHeader) {
                                            ...
                                            if (typeof res === "string") if (_mime && _mime.decode) res = safe(_mime.decode, res);
                                        }
                ...
                function resource(client, parent, name, id, ctx) {
                    ...
                    self.get = function () {
                        ...
                        args.push({api_token: client._opts.apiToken});
                        var url = self.url();
            ...
            /***/ (function (module, exports) {
                ...
                module.exports = function (n) {
                    ...
                    n = n || this, n.on = function (e, r, l) {
                        ...
                        r || (t = {});
                        for (var o = t[r] || e, u = o.length = l ? o.length : 0; u--;) l == o[u][0] && o.splice(u, 1);
                        return n
                    }, n.emit = function (r) {
                        for (var l, o = t[r] || e, u = o.length > 0 ? o.slice(0, o.length) : o, i = 0; l = u[i++];) l[0].apply(l[1], e.slice.call(arguments, 1));
                        return n
                    }
                };
